 ...
 * 
 * Vendored from: https://github.com/KdotJPG/OpenSimplex2
 * License: CC0 (Public Domain)
 * 
 * Note: This smooth variant is provided for optional use in biome blending.
 * The main OpenSimplex2 class is used for most terrain generation.
 */
...
public class OpenSimplex2S {
    ...
    /**
     * 3D OpenSimplex2S noise, with better visual isotropy in (X, Z).
     */
